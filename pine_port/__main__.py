"""CLI for the pine_port pipeline.

  python -m pine_port lint <file.pine> [--json]
      Pre-port analysis: library imports (copy-paste required!), semantic
      traps, builtin inventory, plotted-series inventory.

  python -m pine_port parity --csv <golden.csv> --port <module:function>
...
def main(argv=None):
    p = argparse.ArgumentParser(prog="pine_port", description=__doc__)
